...
export default function ParallaxCTA() {
  ...
  return (
    ...
    >
      <motion.div
        style={reduceMotion ? undefined : { y: yLayer1 }}
      ...
      <motion.div
        style={reduceMotion ? undefined : { y: yLayer2 }}
        className="absolute inset-0 pointer-events-none"
      >
      ...
      >
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur border border-white/20 text-emerald-300 font-bold text-xs uppercase tracking-[0.3em] mb-8">
          ...
          >
            ...
            <a
              ...
              className="px-10 py-5 bg-white/10 backdrop-blur text-white border border-white/20 font-bold rounded-full hover:bg-white/15 transition-all flex items-center justify-center text-lg"
            >
              WhatsApp directo
            </a>
          </motion.div>
