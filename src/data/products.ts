...
export const productsData: Product[] = [
  ...
  { id: 'taladro-50', name: 'TALDRO 20 mg X50', description: 'Indicado para la disfunción eréctil siendo utilizado como Estimulante Sexual.', price: '$2,000.00', featured: true, tag: 'estrella' },
